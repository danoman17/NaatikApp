...
const TextSlider = ({ info, infoLateralBar }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Tab
          _selected={{ color: "white", bg: "#E34956", borderRadius: "50px" }}
        ...
        <Tab
          _selected={{ color: "white", bg: "#70AE47", borderRadius: "50px" }}
        ...
        <Tab
          _selected={{ color: "white", bg: "#EE7D30", borderRadius: "50px" }}
          className="btn-textslider-3"
        >
          <p className="txt-btn-textSlider">Medio</p>
        </Tab>
        <Tab
          _selected={{ color: "white", bg: "#982B52", borderRadius: "50px" }}
